...
- **กล้อง (WebRTC) ยังไม่ได้ทดสอบผ่านหน้าจอ Lovelace จริง** โปรโตคอลที่ใช้คุยกับ
  เซิร์ฟเวอร์กล้องของเครื่องพิมพ์ยืนยันถูกต้องแล้วในระดับ HTTP (ยิง SDP offer/answer ตรงๆ
  ผ่าน curl ได้คำตอบที่ถูกต้อง) แต่การเชื่อมต่อ WebRTC จริงในเบราว์เซอร์ยังไม่ได้ verify
  เพราะพัฒนาจากสภาพแวดล้อมที่ไม่มีการเปิดหน้า Lovelace ผ่านเบราว์เซอร์จริง ถ้าเปิด
  Lovelace แล้วกล้องไม่ขึ้นภาพ ช่วยแจ้งผ่าน issue พร้อม log จาก Developer Tools ของ
  เบราว์เซอร์ด้วย
